...
public class Sopa
{
	public static void main(String args[])
	{
		...
		GlobalSynch globalSynch = new GlobalSynch(50);  // quantum of 50ms
		...
		Memory mem = new Memory(intController,1024);
		Timer timer	= new Timer(intController,globalSynch);
		Disk disk = new Disk(intController,globalSynch,mem,1024,"disk.txt");
		Processor processor = new Processor(intController,
											globalSynch,
											mem,
											console,
											timer,
